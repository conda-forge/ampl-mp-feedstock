...
if [[ "$CONDA_BUILD_CROSS_COMPILATION" != "1" ]]; then
  ...
  TRY_RUN_OUTPUTS="-DHAVE_EXCEL_DRIVER_EXITCODE=0 -DHAVE_EXCEL_DRIVER_EXITCODE__TRYRUN_OUTPUT=\"\" -DHAVE_ODBC_TEXT_DRIVER_EXITCODE=0 -DHAVE_ODBC_TEXT_DRIVER_EXITCODE__TRYRUN_OUTPUT=\"\""
fi
